...
class DLDataTypeCode(ctypes.c_uint8):
    @property
    def label(self):
        return {0: "DLInt", 1: "DLUInt", 2: "DLFloat", 3: "DLOpaqueHandle", 4: "DLBfloat", 5: "DLComplex", 6: "DLBool"}[
            self.value
        ]
...
class DLDevice(DLStructure):
    ...
    _fields_ = [("device_type", DLDeviceType), ("device_id", ctypes.c_int32)]
...
class DLManagedTensorImpl:
    def __init__(
        self, impl_cls, base, pointer, shape, strides, typelabel, nbits, lanes, devicelabel, device_id, offset, flags, version
    ):
...
class DLPackObject:
    ...
    def __dlpack__(self, stream=None):
        ...
        capsule = Capsule.new(self.impl.managed_pointer, DLPACK_CAPSULE_VALID_NAME, DLManagedTensor_capsule_destructor)
...
def asdlpack_array_interface_v3(obj, impl_cls=None):
    ...
    impl = DLManagedTensorImpl(
        impl_cls, obj, pointer, shape, strides, typelabel, nbits, lanes, devicelabel, device_id, offset, flags, version
    )
